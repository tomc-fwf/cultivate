...
import { Sprout, BookOpen, Package, Layers, Grid2x2, LogOut, Droplets } from 'lucide-react';
...
export default function NavBar() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 flex justify-around py-2 px-1 z-50">
      ...
      <NavLink to="/applications/fertigation" className={cls}><Droplets size={22}/><span>Apply</span></NavLink>
